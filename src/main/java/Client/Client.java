...
public class Client {
    ...
    private static void scheduleVirtualMeetup(BufferedWriter writer, BufferedReader reader, Scanner scanner) throws IOException {

        // Prompts for scheduling a virtual meet-up
        System.out.println("\nScheduling a virtual meet-up...");
